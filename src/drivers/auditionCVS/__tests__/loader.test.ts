...
describe('Audition CVS loader', () => {
    it('Check correct load', async () => {
        ...
        expect(res).toEqualRight([{'elementID': 'c0', 'endTimeMs': 60636, 'startTimeMs': 0, 'tags': {'title': 'Intro'}}, {'elementID': 'c1', 'endTimeMs': 89887, 'startTimeMs': 60636, 'tags': {'title': 'Advertising'}}])
    })
